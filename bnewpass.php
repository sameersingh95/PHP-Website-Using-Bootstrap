...
<?php unset($_SESSION['fail_msg']); } ?>
                    ...
                    <form role="form" action="token.php" method="POST">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-cd"></i></span>
                            <input type="text" name="token" class="form-control" pattern="[A-Za-z]{1,25}" required="" placeholder="Enter the token">
                        </div>
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="pass1" class="form-control" pattern="(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{5,15}" required="" placeholder="Confirm Password">
                        </div>
