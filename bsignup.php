         ...
         <div class="container-fluid" >
            ...
            <div class="collapse navbar-collapse" id="mainNavBar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active" style="border-bottom: 2px solid whitesmoke;"><a href="bsignup.php" id="a">Signup</a></li>';
                    }?>
                </ul>
            </div>
            </div>
...
<?php unset($_SESSION['fail_msg']); } ?>
                    ...
                    <form role="form" action="register.php" method="POST">
                        <div class="input-group">
                            ...
                            <input type="text" name="name" class="form-control" pattern="[A-Z a-z]{1,25}" required="" placeholder="Full Name">
                        </div>
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="mobile" class="form-control" maxlength="10" pattern="[7-9]{1}[0-9]{9}" required="" placeholder="Your Mobile">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input type="text" name="username" class="form-control" pattern="[A-Za-z0-9]{5,25}" required="" placeholder="Your Username">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                            <input type="password" name="pass" class="form-control" pattern="(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{5,15}" required="" placeholder="Password">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-duplicate"></i></span>
                            <input type="password" name="npass" class="form-control" pattern="(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{5,15}" required="" placeholder="Confirm Password">
                        </div>
                    ...
                    <div align="center">
                    <a href="bsignin.php" >Existing User?</a>
                </div>
                </div>
            <div class="col-md-4"></div>
