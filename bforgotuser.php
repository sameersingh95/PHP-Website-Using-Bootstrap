...
<?php unset($_SESSION['fail_msg']); } ?>
                    ...
                    <form role="form" action="forgotuser.php" method="POST">
                        <div class="text-nowrap" style="padding: 5px;">
                            Please enter the email address used to create your account below.<br> We will send  your username to you right away.
                        </div>
                ...
                <div align="center">
                    <a href="bsignin.php" >Login to continue..!!</a>
                </div>
                </div>
            <div class="col-md-3"></div>
