...
const CLIENT_ID = '254948154577-hhui9kk5qhhlgov6d3kmta5rcfbkcfhp.apps.googleusercontent.com';
const CLIENT_SECRET = 'r-w9VUETvIwIV6Paj8Fqm3nr';
const REDIRECT_URI = 'http://localhost/bootstrap/index1.php';
