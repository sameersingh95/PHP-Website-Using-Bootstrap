...
<?php unset($_SESSION['fail_msg']); } ?>
                    ...
                    <form role="form" action="forgotpass.php" method="POST">
                        <div class="text-nowrap" style="padding: 5px;">
                            Please provide the email address that you used when you signed up for your account.<br>We will send you an email that will allow you to reset your password.
                        </div>
